...
export default function EasyPaisaPaymentForm({ amount, orderId, onSuccess, onError }: EasyPaisaPaymentProps) {
  ...
  const handlePayment = async () => {
    ...
    if (!validatePhoneNumber(phoneNumber)) {
      setPhoneError('Invalid mobile number. Format: 0345-1234567');
      toast.error('Sahih mobile number darj karein (e.g., 0345-1234567)');
      return;
    }
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/easypaisa/initiate-payment`, {
        method: 'POST',
        headers: {
      ...
      toast.success('EasyPaisa redirect ho raha hai...');
    ...
    <div className="space-y-4">
      ...
      <div className="bg-gradient-to-r from-green-600 to-green-700 rounded-xl p-4 text-white">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h3 className="text-lg font-bold">EasyPaisa Payment</h3>
        </div>
        <p className="text-sm text-green-100">
          Pay securely with your EasyPaisa mobile wallet
        </p>
      </div>
      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            className={`w-full px-4 py-3 pl-12 border rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 transition-all ${
        ...
        <p className="mt-2 text-xs text-gray-500">
          💡 Format: 0345-1234567 or +923451234567
        </p>
      </div>
      ...
      <div className="flex items-center gap-2 text-sm text-gray-500 bg-gray-50 p-3 rounded-lg">
        ...
        <span>Secure payment processed by EasyPaisa</span>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <ol className="text-xs text-blue-700 space-y-1 list-decimal list-inside">
          ...
          <li>You&apos;ll be redirected to EasyPaisa secure page</li>
